Feature: Adult E2E - Applying for CFU role + no medical considerations + Do not require special provisions

			T1180

			Scenario: Adult E2E - Applying for CFU role + no medical considerations + Do not require special provisions
						...
						And candidate continue
						Then candidate fills in volunteer details for "CFU" "data/volunteerDetails_Adult_CFU.json"
						Then candidate continues to police check
						Then candidate fills in police check details "data/policeChkDetails.json"
