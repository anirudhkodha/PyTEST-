Feature: Adult E2E - Applying for fire fighting role, H&S = Cannot + H&S questions all = No + Special Provisions = Yes

			@T1177
			Scenario: Adult E2E - Applying for fire fighting role, H&S = Cannot + H&S questions all = No + Special Provisions = Yes
						...
						And clicks continue
						Then User fills in volunteer details "data/volunteerDetails_Adult_Cannot_SP_Yes.json"
						Then User continues to police check
						Then User fills in police check details "data/policeChkDetails_SP_Yes.json"
