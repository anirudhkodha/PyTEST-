Feature: Adult E2E - Applying for Operational support role + Yes medical considerations + special provisions

			@T1184

			Scenario: Applying for Operational support role
						...
						And clicks continue
						Then User fills in volunteer details for "operational" "data/volunteerDetails_Adult_OperationalSupport.json"
