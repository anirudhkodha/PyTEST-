Feature: Adult E2E - Applying for Community support role + no medical considerations + Require special provisions

			@T1181
			Scenario: Applying for Community support role
						...
						And clicks continue
						Then User fills in volunteer details for "community" "data/volunteerDetails_Adult_CommunitySupport.json"
