Feature: Adult E2E - Applying for fire fighting role + Yes medical considerations + no special provisions

			T1182 T1176

			Scenario: Adult E2E - Applying for fire fighting role + Yes medical considerations + no special provisions
						...
						When Adult candidate enters credentials "Email" "password"
						...
						And clicks continue
						Then User fills in volunteer details "data/volunteerDetails_Adult_FF_MedYes.json"
