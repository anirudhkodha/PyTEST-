Feature: Adult E2E - Applying for Brigade administration Role + Special provision = No

			@T1179
			Scenario: Adult E2E - Applying for Brigade administration Role + Special provision = No
						...
						And clicks continue
						Then User fills in volunteer details for "admin" "data/volunteerDetails_Adult_Admin.json"
