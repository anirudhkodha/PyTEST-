Feature: Adult E2E - Applying for fire fighting role + no medical considerations + Do not require special provisions


			@T1185
			Scenario: Adult E2E - Applying for fire fighting role + no medical considerations + Do not require special provisions
