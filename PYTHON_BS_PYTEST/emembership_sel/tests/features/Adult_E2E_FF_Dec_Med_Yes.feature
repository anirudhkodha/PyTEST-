Feature: Adult E2E - Applying for fire fighting role, H&S = Can + H&S questions one = Yes + Declarations at least 1 = Yes + Special Provisions = No

			@T1186

			Scenario: Adult E2E - Applying for fire fighting role, H&S = Can + H&S questions one = Yes + Declarations at least 1 = Yes + Special Provisions = No
						...
						And clicks continue
						Then User fills in volunteer details "data/volunteerDetails_Adult_FF_Dec_Med_Yes.json"
